...
# ocp7_scoring_model_cloud documentation build
...
from ocp7_scoring_model_cloud import __version__ as release

# -- Project information -----------------------------------------------------

project = "ocp7_scoring_model_cloud"
author = "Kedro"
...
htmlhelp_basename = "ocp7_scoring_model_clouddoc"
...
latex_documents = [
    (
        master_doc,
        "ocp7_scoring_model_cloud.tex",
        "ocp7_scoring_model_cloud Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "ocp7_scoring_model_cloud",
        "Project ocp7_scoring_model_cloud codebase.",
        "Data-Science",
    )
]
